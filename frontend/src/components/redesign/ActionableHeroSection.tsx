    ...
    <div className={`relative rounded-xl shadow-2xl p-8 text-white bg-gradient-to-br ${gradient} overflow-hidden`}>
      ...
      <div className="relative z-10">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          {isProjectComplete && (
            <a
              href={`/projects/${workspace.id}/results?filter=final`}
              className="group px-6 py-3 bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-lg font-semibold text-sm hover:from-green-500 hover:to-emerald-600 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center animate-pulse"
            >
